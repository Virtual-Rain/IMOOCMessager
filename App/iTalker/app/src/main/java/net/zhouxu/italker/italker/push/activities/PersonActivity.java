...
import net.zhouxu.italker.common.app.PresenterToolbarActivity;
import net.zhouxu.italker.common.widget.PortraitView;
import net.zhouxu.italker.factory.model.db.User;
import net.zhouxu.italker.factory.presenter.contact.PersonalContract;
import net.zhouxu.italker.factory.presenter.contact.PersonalPresenter;
import net.zhouxu.italker.italker.push.R;

import butterknife.BindView;
import butterknife.OnClick;

public class PersonActivity extends PresenterToolbarActivity<PersonalContract.Presenter>
implements PersonalContract.View{
    ...
    @Override
    public void setFolllowStatus(boolean isFollow) {
